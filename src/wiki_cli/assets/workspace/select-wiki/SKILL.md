...
After selecting it, read `<wiki>/WIKI.md` and `<wiki>/TOPIC.md` before acting. Those files define the schema, scope, and operating rules. Apply the shared `prose-voice` skill only to files in the selected wiki.
