...
```bash
uvx --from git+https://github.com/valinor-consulting/llm-wiki-cli.git@v0.4.1 llm-wiki init my-wiki
```
...
uv tool install --force \
  --from git+https://github.com/valinor-consulting/llm-wiki-cli.git@v0.4.1 \
  llm-wiki-cli
llm-wiki --version
```
